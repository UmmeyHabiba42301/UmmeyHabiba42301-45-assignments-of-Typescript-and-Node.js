...
let favorite_fruits: string [] = ['watermelon','pineapple','guava']
if(favorite_fruits.includes('watermelon')){console.log('You really like watermelon!')}
if(favorite_fruits.includes('pineapple')){console.log('You really like pineapple!')}
...
if(favorite_fruits.includes('guava')){console.log('You really like guavas!')}